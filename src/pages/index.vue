  ...
  <v-container max-width="700">
    ...
    <div class="exe-zone">
      ...
      <v-card class="mx-auto my-6 pa-2" max-width="400">
        ...
        <v-card-subtitle :style="{ color: colorTxt }">
          {{ description }}
        </v-card-subtitle>
...
const colorTxt = ref("black");
const btnText = ref("Mettre en surbrillance");
...
function highlighted() {
  if (isHighlighted.value) {
    ...
    colorTxt.value = "black";
    btnText.value = "Mettre en surbrillance";

  }
  isHighlighted.value = !isHighlighted.value; // Basculer l'état
}
</script>
